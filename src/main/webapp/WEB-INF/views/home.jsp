				...
				<div class="col-md-2">
					<c:choose>
						<c:when test="${user == 'ADMIN'}">
                                                    <p><a class="btn btn-success" href="/products/add">Add Product</a></p>
                                                    <p>   <a class="btn btn-success" href="http://localhost:8090/testAPI">TEST API</a></p>
						</c:when>
						<c:otherwise>
...
//                $('#products').append(item);
                 var item ='<tr>'
                        +'<td>'+s[key].productName+'</td> ' 
                        +'<td>'+s[key].description +'</td> ' 
                        +'<td>'+s[key].price +'</td> ' 
                        +'<td>'+s[key].productType +'</td> ' 
                    +'<td> ' 
                    +'<a href="#" class="btn btn-default add" data-q="0" data-id="'+s[key].id+'" role="button">Add to My Order</a> ' 
                    +'<span></span>' 
                    +'</td> ' 
